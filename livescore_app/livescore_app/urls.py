"""livescore_app URL Configuration
...
from views.views import home_view, tournamentDetail, gameDetail, playerDetail, createGame
urlpatterns = [
    ...
    path('tournament/<int:tournament_id>/createGame',createGame),
